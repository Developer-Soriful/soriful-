      ...
      <div className="lg:hidden flex justify-center items-center mt-6 md:mt-8 xl:mt-10 mb-6 md:mb-8 xl:mb-10 px-10">
        <div className="relative w-full max-w-sm md:max-w-md group">
          ...
          <div className="relative z-10 transform transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2 professional-image">
            ...
            <div className="absolute -top-8 -left-8 text-xs font-bold text-blue-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-bounce" style={{ animationDelay: '0.2s' }}>
              REACT
            </div>
            <div className="absolute -top-6 -right-6 text-xs font-bold text-purple-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-bounce" style={{ animationDelay: '0.4s' }}>
              NODE.js
            </div>
            <div className="absolute -bottom-6 -left-6 text-xs font-bold text-pink-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-bounce" style={{ animationDelay: '0.6s' }}>
              MONGODB
            </div>
            <div className="absolute -bottom-8 -right-8 text-xs font-bold text-cyan-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-bounce" style={{ animationDelay: '0.8s' }}>
              EXPRESS
            </div>
            
            {/* Rotating Skill Icons */}
            <div className="absolute top-1/2 -left-12 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-spin" style={{ animationDelay: '0.3s' }}>
              <span className="text-white text-xs font-bold">JS</span>
            </div>
            <div className="absolute top-1/2 -right-12 w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-spin" style={{ animationDelay: '0.5s' }}>
              <span className="text-white text-xs font-bold">TS</span>
            </div>
            
            {/* Floating Code Elements */}
            <div className="absolute top-1/4 -left-16 text-xs text-green-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '0.7s' }}>
              &lt;/&gt;
            </div>
            <div className="absolute bottom-1/4 -right-16 text-xs text-yellow-400 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '0.9s' }}>
              { }
            </div>
            
            {/* Additional Tech Stack Elements */}
            <div className="absolute top-1/3 -left-20 text-xs font-mono text-blue-300 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '1.0s' }}>
              HTML5
            </div>
            <div className="absolute top-2/3 -right-20 text-xs font-mono text-purple-300 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '1.1s' }}>
              CSS3
            </div>
            <div className="absolute bottom-1/3 -left-20 text-xs font-mono text-pink-300 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '1.2s' }}>
              API
            </div>
            <div className="absolute bottom-2/3 -right-20 text-xs font-mono text-cyan-300 opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-pulse" style={{ animationDelay: '1.3s' }}>
              Git
            </div>
            
            {/* Animated Dots Pattern */}
            <div className="absolute -top-4 -left-4 w-2 h-2 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-ping" style={{ animationDelay: '1.4s' }}></div>
            <div className="absolute -top-4 -right-4 w-2 h-2 bg-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-ping" style={{ animationDelay: '1.5s' }}></div>
            <div className="absolute -bottom-4 -left-4 w-2 h-2 bg-pink-500 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-ping" style={{ animationDelay: '1.6s' }}></div>
            <div className="absolute -bottom-4 -right-4 w-2 h-2 bg-cyan-500 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 group-hover:animate-ping" style={{ animationDelay: '1.7s' }}></div>
            ...
            <img 
              ...
              loading="eager"
              style={{
                filter: 'drop-shadow(0 20px 40px rgba(0, 0, 0, 0.4)) drop-shadow(0 0 20px rgba(59, 130, 246, 0.3))',
                transform: 'translateY(0)',
                transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)',
                backgroundColor: 'linear-gradient(135deg, #0e0e10 0%, #1c1c21 50%, #282732 100%)'
              }}
            />
